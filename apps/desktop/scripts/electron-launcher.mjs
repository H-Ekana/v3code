// This file mostly exists because we want dev mode to say "V3 Code (Dev)" instead of "electron"
...
const devBundleIdSuffix = NodePath.basename(repoRoot)
  .toLowerCase()
  .replaceAll(/[^a-z0-9]+/g, "");
export const APP_DISPLAY_NAME = isDevelopment ? "V3 Code (Dev)" : "V3 Code (Alpha)";
export const APP_BUNDLE_ID = isDevelopment
  ? `com.v3code.desktop.dev.${devBundleIdSuffix || "local"}`
  : "com.v3code.desktop";
const APP_PROTOCOL_SCHEMES = isDevelopment ? ["v3code-dev"] : ["v3code"];
...
function buildMacLauncher(electronBinaryPath) {
  ...
  if (isDevelopment) {
    ...
    // Electron.app even though this bundle's Info.plist has the V3 Code name.
