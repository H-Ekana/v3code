...
const MobileRunContextSelector = memo(function MobileRunContextSelector({
  ...
  if (isLocked) {
    return (
      <span className="inline-flex min-w-0 max-w-[48%] flex-1 items-center justify-start gap-1 rounded-md border border-transparent px-[calc(--spacing(2)-1px)] text-sm font-medium text-muted-foreground/80 md:hidden">
        {triggerContent}
      </span>
    );
  }
  ...
  return (
    <Menu>
      <MenuTrigger
        ...
        className="min-w-0 max-w-[48%] flex-1 justify-start text-muted-foreground/80 hover:text-foreground/95 md:hidden"
      >
        {triggerContent}
