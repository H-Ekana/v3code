...
describe("SplashScreen", () => {
  ...
  it("uses varied ambient motion with reduced-motion fallbacks", () => {
    ...
    expect(starsSvg).toContain("animation: star-twinkle 4s");
    expect(starsSvg).toContain("drop-shadow(0 0 12px");
    expect(starsSvg).toContain("@keyframes sky-rotation");
    expect(starsSvg).toContain("animation: sky-rotation 18s");
    expect(starsSvg).toContain('class="sky-overscan"');
    expect(starsSvg).toContain("transform: scale(1.045)");
    expect(starsSvg).toContain("transform: rotate(-.7deg)");
    expect(starsSvg).toContain("transform: rotate(.7deg)");
    expect(starsSvg).not.toContain("rotate(360deg)");
    ...
    expect(cloudsSvg).toContain("animation: cloud-drift 20s");
    expect(cloudsSvg).toContain("--cloud-end-x: 30px");
