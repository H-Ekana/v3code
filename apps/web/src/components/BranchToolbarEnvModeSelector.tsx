...
export const BranchToolbarEnvModeSelector = memo(function BranchToolbarEnvModeSelector({
  ...
  if (envLocked) {
    return (
      <span className="inline-flex shrink-0 items-center gap-1 border border-transparent px-[calc(--spacing(3)-1px)] text-sm font-medium text-muted-foreground/80 sm:text-xs">
        {activeWorktreePath ? (
          <>
  ...
  return (
    ...
    >
      <SelectTrigger
        variant="ghost"
        size="xs"
        className="min-w-0 shrink font-medium text-muted-foreground/80 hover:text-foreground/95"
