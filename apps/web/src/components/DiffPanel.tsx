...
export default function DiffPanel({
  ...
  useEffect(() => {
    ...
    codeViewInstanceRef.current?.scrollTo({
      type: "item",
                          ...
                          <TooltipTrigger
                            render={
                              <button
                                type="button"
                                className={cn(
                                  "-ms-0.5 inline-flex size-5 shrink-0 cursor-pointer items-center justify-center rounded-sm border-0 bg-transparent p-0 transition-[background-color,color] duration-200 hover:bg-primary/10 hover:text-primary focus-visible:outline-hidden motion-reduce:transition-none",
