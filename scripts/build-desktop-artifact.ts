...
export const DESKTOP_FILE_EXCLUSIONS = [
  ...
  // Source maps are useful in build output but the desktop runtime does not
  // consume them. Keeping them out of the installer removes both application
  // and dependency maps without changing local debugging artifacts.
  "!**/*.map",
...
export const createBuildConfig = Effect.fn("createBuildConfig")(function* (
  ...
  const buildConfig: Record<string, unknown> = {
    ...
    extraResources: [...DESKTOP_EXTRA_RESOURCES, BUNDLED_CODEX_PLUGIN_EXTRA_RESOURCE],
  };
