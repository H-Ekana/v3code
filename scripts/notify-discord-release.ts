  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new V3 Code prerelease is available for nightly testers."
          : "A new V3 Code latest release is available.",
...
).pipe(Command.withDescription("Post a V3 Code release announcement to Discord."));
